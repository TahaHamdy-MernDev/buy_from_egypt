...
function CompanyInfo({ slug }: { slug: string }) {
  return (
    <div className="bg-white p-4 flex flex-col gap-4 rounded-xl mt-6">
      <div className="flex flex-col gap-4 justify-start">
        ...
        <p className="text-stone-400 leading-tight">
          Our vision and approach <br />
          Samsung follows a simple business philosophy: dedicating its talents
          and technology to creating world-class products and services that
          contribute to a better global society. To achieve this, Samsung places
          high value on its people and technology.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4 justify-start">
        ...
        <div className="flex items-start flex-col gap-3">
          <div className="flex items-center gap-2">
            ...
            <p>Plot 81, Road 90, 5th Settlement</p>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-stone-400 flex gap-2">
              <svg
      ...
      <div className="flex flex-col gap-4 justify-start">
        ...
        <div className="cursor-pointer size-10  rounded-full flex-center">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
