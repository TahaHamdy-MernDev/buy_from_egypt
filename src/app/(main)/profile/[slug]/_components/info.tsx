...
function Info({
  ...
  return (
    <div className="w-full">
      <AspectRatio ratio={20 / 5} className="relative">
        <div className="cursor-pointer size-9 absolute top-3 right-3 bg-white rounded-full flex-center">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
        ...
        <div className="flex  flex-row justify-between gap-4 w-full h-full">
          <div className="w-56 h-36 ">
            <Image
              ...
              width={192}
              height={192}
              className="w-48 h-48 rounded-lg object-cover ml-8 transform -translate-y-14 "
            />
          </div>
